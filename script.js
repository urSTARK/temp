...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Aug 09, 2025 00:00:00').getTime(),
...
new TypeIt("#teks2", {
  strings: ["With or without me, may the universe always keep you happy in every possible way.May God bless your life with good health, peace, and success.Thank you for coming this far and continuing to inspire us.Wishing you all the best in everything you do.", "once again"," ", "HAPPY BIRTHDAY DEEPAK MOSAJI", ""],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
